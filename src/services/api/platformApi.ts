...
function normalizeProgress(source: UnknownRecord | null): ProgressSnapshot | undefined {
  ...
  return {
    ...
    listening: num(source.listening ?? source.progress_listening),
    pronunciation: num(source.pronunciation ?? source.progress_pronunciation),
    homeworkCompletionRate: num(source.homeworkCompletionRate ?? source.homework_completion_rate),
